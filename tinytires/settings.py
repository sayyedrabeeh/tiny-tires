"""
Django settings for tinytires project.
...
SECRET_KEY = 'django-insecure-75-62%5z5&s$_%+^hnwpa3t-_c2q&!!y$n=t%!h)^#rept(_ol'
...
WSGI_APPLICATION = 'tinytires.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tinytires',  # Replace with your database name
...
# URL to access static files (e.g., http://127.0.0.1:8000/static/)
STATIC_URL = '/static/'

# Ensure Django knows where to find the static files
STATICFILES_DIRS = [
